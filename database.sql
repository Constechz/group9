...
-- Seed Managers
INSERT INTO `managers` (`manager_id`, `manager_name`, `manager_role`) VALUES
(1, 'Hafsah Salifu', 'General Manager'),
(2, 'Moses Sedodey', 'Operations Manager');

-- Seed Students
INSERT INTO `students` (`student_id`, `surname`, `first_name`, `middle_name`, `date_of_birth`, `place_of_birth`, `residential_address`, `telephone`, `email`, `national_id`, `occupation`, `permit_number`, `permit_expiry_date`) VALUES
...
-- Seed Registrations (Deposit & Balance calculated manually here)
INSERT INTO `registrations` (`registration_id`, `registration_date`, `commencement_date`, `completion_date`, `course_name`, `total_cost`, `deposit`, `balance`, `student_id`, `manager_id`) VALUES
...
-- Seed Payments
INSERT INTO `payments` (`payment_id`, `payment_date`, `amount`, `payment_type`, `balance_after_payment`, `registration_id`) VALUES
...
-- Let's update registration 1's balance to reflect the second payment in registrations table
UPDATE `registrations` SET `balance` = 300.00 WHERE `registration_id` = 1;

-- Seed Instructors
INSERT INTO `instructors` (`instructor_id`, `instructor_name`, `instructor_dob`, `national_id`, `license_number`, `license_type`, `telephone`, `email`) VALUES
...
-- Seed Vehicles
INSERT INTO `vehicles` (`vehicle_id`, `vehicle_registration_no`, `vehicle_identity_no`, `vehicle_type`, `status`) VALUES
...
-- Seed Lessons
INSERT INTO `lessons` (`lesson_id`, `lesson_type`, `lesson_date`, `start_time`, `end_time`, `status`, `registration_id`, `instructor_id`, `vehicle_id`) VALUES
